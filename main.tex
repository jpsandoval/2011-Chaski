...
The two object-centric and message-centric blueprints are two instance of Chaski, our framework to visualize object-oriented execution traces. 
...
The Execution Mural visualization shows time on the horizontal axis and messages passed between classes in a program on the vertical~\figref{ExecutionMuralDemo}. This take the approach of creating a general view showing all the classes and messages. Where the classes are on vertical axis, and each message is single line of 1 pixel wide from source to destination class.
